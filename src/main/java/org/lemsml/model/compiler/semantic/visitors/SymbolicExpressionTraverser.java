...
public class SymbolicExpressionTraverser<E extends Throwable> implements Traverser<E> {

	@Override
	public void traverse(org.lemsml.model.extended.ComponentType aBean, Visitor<?, E> aVisitor) throws E {
